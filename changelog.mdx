...
<Update label="July 20, 2026" tags={["Agent"]}>
  ...
  **Upgrading the agent:** run `composer update nightowl/agent` and restart the agent — the migration step now happens on boot. See the [agent changelog (2.0.0)](https://github.com/lemed99/nightowl-agent/blob/main/CHANGELOG.md#200---unreleased) for details.
</Update>
...
<Update label="July 11, 2026" tags={["Agent", "Dashboard"]}>
  ...
  **Upgrading the agent:** run `composer update nightowl/agent`, then in the monitored app run `php artisan nightowl:migrate` and `php artisan nightowl:backfill-rollups`, and restart the agent. See the [agent changelog](https://github.com/lemed99/nightowl-agent/blob/main/CHANGELOG.md#1212---2026-07-11) for the exact steps.
</Update>
