...
<Update label="July 20, 2026" tags={["Agent"]}>
  ...
  **Upgrading the agent:** run `composer update nightowl/agent` and restart the agent — the migration step now happens on boot. See the [agent changelog (1.5.0)](https://github.com/lemed99/nightowl-agent/blob/main/CHANGELOG.md#150---2026-07-20) for details.
</Update>
