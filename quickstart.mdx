...
<Note>
  The `nightowl_*` tables live in the BYO PostgreSQL database you configured above — not your app's primary database. You only need to initialize a given NightOwl database once.
</Note>
